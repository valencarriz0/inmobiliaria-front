...
export function isOwnProperty(user: AuthUser | null, property: object) {
  return user?.role === "publisher" && "publisherId" in property && property.publisherId === MOCK_CURRENT_PUBLISHER_ID;
}
